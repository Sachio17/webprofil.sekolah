...
<main class="app-main">
  ...
  <div class="app-content-header">
    ...
    <div class="container-fluid">
          <!--begin::Row-->
          <div class="row">
          <div class="col-sm-6"><h3 class="mb-0">Data Sekolah</h3></div>
        <div class="col-sm-6">
            ...
            <div class="app-content">
                ...
                <div class="row">
                   <div class="col-md-12">
                    <div class="card-mb-10">
                      <div class="card-header"><h3 class="card-title">Data Profil Sekolah</h3></div>
              ...
              <table class="table table-bordered table-striped">
                ...
                ?>
                  ...
                  <td><img src="../gambar/<?php echo $d['logo']; ?>" width="150">
</td>
                    <td><?php echo $d['visi']; ?></td>
                    <td><?php echo $d['misi']; ?></td>
                     <td><?php echo $d['deskripsi']; ?></td>
                    <td class="text-center">
                      <a href="edit_sekolah.php?id=<?= $d['id']; ?>"
                         class="btn btn-sm btn-warning me-1"
                         title="Edit">
                        <i class="bi bi-pencil-square"></i>
                      </a>

                      <a href="hapus_sekolah.php?id=<?= $d['id']; ?>"
