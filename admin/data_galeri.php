                ...
                <div class="row">
                   <div class="col-md-12">
                    <div class="card-mb-10">
                      <div class="card-header"><h3 class="card-title">Data Galeri</h3></div>
              ...
              <table class="table table-bordered">
                ...
                ?>
                  <tr>
                    ...
                    <td><img src="../gambar/<?php echo $d['gambar']; ?>" width="150">
</td>
                    <td><?php echo $d['tanggal_upload']; ?></td>
                     
                    <td class="text-center">
                      <a href="edit_galeri.php?id=<?= $d['id']; ?>"
                         class="btn btn-sm btn-warning me-1"
                         title="Edit">
                        <i class="bi bi-pencil-square"></i>
                      </a>

                      <a href="hapus_galeri.php?id=<?= $d['id']; ?>"
